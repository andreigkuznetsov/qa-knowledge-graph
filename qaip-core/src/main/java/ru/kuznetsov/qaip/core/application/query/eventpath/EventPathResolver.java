...
/** Shared Runtime resolver for an existing operation in one project snapshot. */
public final class EventPathResolver {
    ...
    public EventPathQueryResult resolve(Project project, String projectId, String operationId) {
