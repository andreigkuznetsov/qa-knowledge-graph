...
class ScenarioIdentityGroupV1CoverageManifestTest {
    ...
    @Test void manifestEnumeratesRemainingNormativeFamilies(){assertEquals(11,ScenarioIdentityGroupV1GoldenBytesTest.vectors().size());assertEquals(7,ScenarioIdentityGroupV1FailureBoundaryTest.INVENTORY.size());assertEquals(Set.of("13 support rows","22 integrity categories","correspondence","2 unavailable reasons","4 group states","ordering relocation","anti-substitution","unexpected failures","11 canonical-byte goldens","4 production states"),NORMATIVE_FAMILIES);}
    private static final Set<String> NORMATIVE_FAMILIES=Set.of("13 support rows","22 integrity categories","correspondence","2 unavailable reasons","4 group states","ordering relocation","anti-substitution","unexpected failures","11 canonical-byte goldens","4 production states");
