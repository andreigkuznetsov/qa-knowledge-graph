...
class ManifestSemanticCompositionAttemptV1Test {
    ...
    static ScenarioOccurrenceCompositionOutcomeV1 attemptChild(NormalizedScenarioOccurrenceInputV1 o){return ScenarioOccurrenceCompositionAttemptV1.attemptScenarioOccurrenceCompositionV1(o);}
    static VerifiedAdmittedManifestV1 verified(ScenarioIdentityGroupComposerV1Test.Fixture f,List<NormalizedScenarioOccurrenceInputV1> c){var p=c.getFirst().parentMember();var mi=c.getFirst().occurrenceIdentity().manifest();
